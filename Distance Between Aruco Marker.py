...
#DESCRIPTION: THIS CODE IS FOR PEOPLE WHO ARE TRYING TO WORK WITH ARUCO MARKERS AND ARE UNABLE TO FIND THE WORKING RESOURCE
# THIS CODE FINDS THE DISTANCE BETWEEN 2 ARUCO MARKERS WITH THE ACCURACY OF FEW INCHES 
import cv2
import imutils
import time
